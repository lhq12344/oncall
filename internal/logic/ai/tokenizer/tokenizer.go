...
func loadTokenizationConfig(ctx context.Context) (apiKey string, baseURL string, model string, err error) {
	apiKey = readTokenizationSetting(ctx, "ds_quick_chat_model.api_key", "DS_QUICK_CHAT_MODEL_API_KEY")
	baseURL = readTokenizationSetting(ctx, "ds_quick_chat_model.base_url", "DS_QUICK_CHAT_MODEL_BASE_URL")
	model = readTokenizationSetting(ctx, "ds_quick_chat_model.model", "DS_QUICK_CHAT_MODEL_MODEL")
...
func readTokenizationSetting(ctx context.Context, configKey, envKey string) string {
